...
| `claude-config` | idem                                       | `settings.json`: mode `auto`, modele `opus[1m]`                             | reprendre comme etat declaratif initial                                 |
| `claude-config` | idem                                       | `lotusim-developer`: nettoyage robuste des processus Gazebo                 | reprendre dans la variante Claude                                       |
| `claude-config` | idem                                       | `openclaw`: documentation Nestor/Hermes et heartbeat 30 min                 | reprendre dans la variante Claude, sans promouvoir vers `shared/`       |
...
| ---------------------------- | --------------------------------- | ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| 7 skills locaux portables    | Claude + Codex, arbres identiques | homes Claude/Codex                                   | source unique `shared/skills`; hub `~/.agents/skills`; miroirs Claude et OpenCode                        |
...
Les sept skills locaux portables sont : `api-design`, `deployment`, `mvp`,
`nvim-config`, `stack-python`, `stack-rust` et `stack-ts`. `grill-with-docs`
suit desormais directement le manifest Matt Pocock, avec `grilling` et
...
| skills personnels      | `~/.claude/skills`                           | liens par skill                     | variants Claude dans `harnesses/claude/skills`                            |
...
| skills specifiques    | `~/.codex/skills`              | liens par skill                   | variants Codex dans `harnesses/codex/skills`                        |
...
| skills specifiques | `~/.kimi-code/skills`                      | liens par skill                     | variants Kimi dans `harnesses/kimi/skills`                                                                                   |
...
- Aucun fichier gere ou script deploye ne contient `claude-config`,
  `codex-config` ou `kimi-config` comme chemin source.
